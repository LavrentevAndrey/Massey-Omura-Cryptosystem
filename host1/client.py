...
if __name__ == "__main__":
    ...
    import threading
    server_thread = threading.Thread(target=start_server, args=('localhost', alice_port, massey_omura))
    server_thread.start()

    # Send a message to the server
    decrypted_message = send_message('localhost', bob_port, message, massey_omura)
